(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/elements'), require('lodash'), require('@fortawesome/free-solid-svg-icons'), require('@fortawesome/free-regular-svg-icons'), require('@angular/forms'), require('rxjs/operators'), require('rxjs'), require('ngx-image-zoom'), require('@fortawesome/angular-fontawesome'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ocm-components', ['exports', '@angular/core', '@angular/elements', 'lodash', '@fortawesome/free-solid-svg-icons', '@fortawesome/free-regular-svg-icons', '@angular/forms', 'rxjs/operators', 'rxjs', 'ngx-image-zoom', '@fortawesome/angular-fontawesome', '@angular/common'], factory) :
    (global = global || self, factory(global['ocm-components'] = {}, global.ng.core, global.ng.elements, global.lodash, global.freeSolidSvgIcons, global.freeRegularSvgIcons, global.ng.forms, global.rxjs.operators, global.rxjs, global.ngxImageZoom, global.angularFontawesome, global.ng.common));
}(this, function (exports, core, elements, lodash, freeSolidSvgIcons, freeRegularSvgIcons, forms, operators, rxjs, ngxImageZoom, angularFontawesome, common) { 'use strict';
    ...
    var OCMProductCard = /** @class */ (function () {
        function OCMProductCard() {
            ...
            this.addedToCart = new core.EventEmitter();
            this.setIsFavorite = new core.EventEmitter();
            this.routeToProductDetails = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            /** @type {?} */
            var filtered = lodash.without(result, undefined);
        ...
        OCMProductCard.propDecorators = {
            ...
            quantityLimits: [{ type: core.Input }],
            addedToCart: [{ type: core.Output }],
            setIsFavorite: [{ type: core.Output }],
            routeToProductDetails: [{ type: core.Output }]
        };
    ...
    var OCMToggleFavorite = /** @class */ (function () {
        function OCMToggleFavorite() {
            this.faHeartFilled = freeSolidSvgIcons.faHeart;
            this.faHeartOutline = freeRegularSvgIcons.faHeart;
        ...
        OCMToggleFavorite.propDecorators = {
            ...
            favoriteChanged: [{ type: core.Output }]
        };
    ...
    var OCMQuantityInput = /** @class */ (function () {
        function OCMQuantityInput() {
            this.qtyChange = new core.EventEmitter();
        ...
        function () {
            this.form = new forms.FormGroup({
                quantity: new forms.FormControl(1, [forms.Validators.required]),
            });
        };
        /**
         * @return {?}
        ...
        function () {
            var _this = this;
            this.form.valueChanges.pipe(operators.debounceTime(500)).subscribe((/**
             * @return {?}
             */
            function () {
        ...
        OCMQuantityInput.propDecorators = {
            ...
            existingQty: [{ type: core.Input }],
            qtyChange: [{ type: core.Output }]
        };
    ...
    var OCMProductCarousel = /** @class */ (function () {
        function OCMProductCarousel() {
            this.products = [];
            this.setIsFavorite = new core.EventEmitter();
            this.navigateToProductDetails = new core.EventEmitter();
            this.index = 0;
            this.rowLength = 4;
            this.faAngleLeft = freeSolidSvgIcons.faAngleLeft;
            this.faAngleRight = freeSolidSvgIcons.faAngleRight;
        }
        /**
         * @return {?}
         */
        ...
        OCMProductCarousel.propDecorators = {
            ...
            quantityLimits: [{ type: core.Input }],
            favoriteProducts: [{ type: core.Input }],
            setIsFavorite: [{ type: core.Output }],
            navigateToProductDetails: [{ type: core.Output }]
        };
    ...
    var OCMProductDetails = /** @class */ (function () {
        function OCMProductDetails(changeDetectorRef) {
            ...
            this.addToCartEvent = new core.EventEmitter();
            this.setIsFavorite = new core.EventEmitter();
        ...
        function () {
            ...
            this.hasPrice = lodash.has(this.product, 'PriceSchedule.PriceBreaks[0].Price');
        ...
        function () {
            ...
            /** @type {?} */
            var startingBreak = lodash.minBy(priceBreaks, 'Quantity');
            /** @type {?} */
        ...
        OCMProductDetails.propDecorators = {
            ...
            isFavorite: [{ type: core.Input }],
            quantityLimits: [{ type: core.Input }],
            addToCartEvent: [{ type: core.Output }],
            setIsFavorite: [{ type: core.Output }]
        };
    ...
    var OCMSpecForm = /** @class */ (function () {
        function OCMSpecForm() {
            ...
            this.specForm = new forms.FormGroup({});
        }
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            function (spec) {
                ...
                /** @type {?} */
                var input = new forms.FormControl(defaultOption, spec.Required ? [forms.Validators.required] : []);
        ...
        function (spec) {
            ...
            if (!spec.Required)
                return null;
            return lodash.get(spec, 'Options[0].ID', null);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            var _this = this;
            /** @type {?} */
            var specIDs = lodash.keys(lodash.pickBy(this.specForm.value, lodash.identity));
            /** @type {?} */
    ...
    var OCMOrderSummary = /** @class */ (function () {
        ...
        function (field) {
            ...
            return new common.CurrencyPipe('en-US').transform(this.order["" + field]);
        };
    ...
    var OCMLineitemTable = /** @class */ (function () {
        function OCMLineitemTable() {
            this.closeIcon = freeSolidSvgIcons.faTimes;
            this.deleteLineItem = new core.EventEmitter();
            this.updateQuantity = new core.EventEmitter();
            this.navigateToProductDetails = new core.EventEmitter();
        }
        /**
         * @param {?} object
         ...
         */
        function (lineItemID) {
            return lodash.get(this.getLineItem(lineItemID), 'Product.xp.Images[0].Url', 'http://placehold.it/300x300');
        };
        /**
         * @param {?} lineItemID
         * @return {?}
        ...
        OCMLineitemTable.propDecorators = {
            lineItems: [{ type: core.Input }],
            readOnly: [{ type: core.Input }],
            quantityLimits: [{ type: core.Input }],
            deleteLineItem: [{ type: core.Output }],
            updateQuantity: [{ type: core.Output }],
            navigateToProductDetails: [{ type: core.Output }]
        };
    ...
    var OCMCart = /** @class */ (function () {
        function OCMCart() {
            this.emptyCart = new core.EventEmitter();
            this.deleteLineItem = new core.EventEmitter();
            this.updateQuantity = new core.EventEmitter();
            this.navigateToProductDetails = new core.EventEmitter();
            this.navigateToProductList = new core.EventEmitter();
            this.navigateToCheckout = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        OCMCart.propDecorators = {
            ...
            lineItems: [{ type: core.Input }],
            quantityLimits: [{ type: core.Input }],
            emptyCart: [{ type: core.Output }],
            deleteLineItem: [{ type: core.Output }],
            updateQuantity: [{ type: core.Output }],
            navigateToProductDetails: [{ type: core.Output }],
            navigateToProductList: [{ type: core.Output }],
            navigateToCheckout: [{ type: core.Output }]
        };
        return OCMCart;
    }());
    if (false) {
    ...
    var OcmComponentsModule = /** @class */ (function () {
        ...
        function (angularComponent, htmlTagName) {
            /** @type {?} */
            var component = elements.createCustomElement(angularComponent, {
        ...
        OcmComponentsModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule,
                            ngxImageZoom.NgxImageZoomModule,
    ...
    exports.ɵa = OCMProductCard;
    exports.ɵb = OCMToggleFavorite;
    exports.ɵc = OCMQuantityInput;
    exports.ɵd = OCMProductCarousel;
    exports.ɵe = OCMProductDetails;
    exports.ɵf = OCMImageGallery;
    exports.ɵg = OCMSpecForm;
    exports.ɵh = OCMOrderSummary;
    exports.ɵi = OCMLineitemTable;
    exports.ɵj = OCMCart;
